    ...
    <View style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={{paddingHorizontal: 10}}>
          <LinearGradient colors={['#332B8A', '#905DE9']} style={styles.toning}>
            <View>
              <Text style={{fontSize: 20, color: Colors.WHITE}}>
                Full Body Toning
              </Text>
              <Text style={{fontSize: 20, color: Colors.WHITE}}>Workout</Text>
              <Text style={{color: '#F1F4F8', fontSize: 14, marginTop: 10}}>
                Includes circuits to work
              </Text>
              <Text style={{color: '#F1F4F8', fontSize: 14}}>every muscle</Text>
        ...
        <View style={styles.bodyHead}>
          <View>
            ...
            <Text style={{color: '#F1F4F8', fontSize: 12}}>Workouts:80</Text>
          </View>
          <TouchableOpacity>
            <Text style={styles.viewAll}>View All</Text>
          </TouchableOpacity>
            ...
            <View>
              ...
              <View style={{paddingHorizontal: 5}}>
                ...
                <View style={styles.boxFooterText}>
                  <Text style={{fontSize: 12, color: '#9662F1'}}>Beginner</Text>
        ...
        <View style={styles.bodyHead}>
          <View>
            ...
            <Text style={{color: '#F1F4F8', fontSize: 12}}>Exercises:210</Text>
          </View>
          <TouchableOpacity
